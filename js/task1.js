...
const getUsersWithEyeColor1=(users, color) => users.filter(user=>user.eyeColor === color)
;
console.log(getUsersWithEyeColor1(users, 'blue'));
...
const getInactiveUsers = (users, isActive) => users.filter(user=>user.isActive === false);
